...
| Local Docker PostgreSQL              | `IEventStore`, `IRoleAssignmentStore`, `IPersonKeyMap` integration | Azure Database for PostgreSQL Flexible Server (DEC-001)                                  | P1-T07/P1-T08 tests/CI, disposable loopback database only   | implemented |
